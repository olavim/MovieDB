(function ($) {
    ...
    function sortJSON(data, prop, asc) {
        data.sort(function(a, b) {
            var al = (typeof a[prop] === 'string' || a[prop] instanceof String) ? a[prop].toLowerCase() : a[prop];
            var bl = (typeof b[prop] === 'string' || b[prop] instanceof String) ? b[prop].toLowerCase() : b[prop];
